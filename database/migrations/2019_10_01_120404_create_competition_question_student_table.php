...
class CreateCompetitionQuestionStudentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('competition_question_student', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('competition_question_student');
    }
}
