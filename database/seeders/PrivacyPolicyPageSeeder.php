...
class PrivacyPolicyPageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // top header
        $blocks[] = [
            'slug' => 'privacy-policy-top-header',
            'url' => null,
            'is_active' => 1,
            'bg_image' => null,
            'icon' => null,
            ...
            'child' => [
                [
                    // Top header Logo
                    'slug' => 'privacy-policy-top-header-logo',
                    'url' => null,
                    'is_active' => 1,
                    'bg_image' => null,
                    'icon' => null,
                ...
                [
                    // Top Header Menu
                    'slug' => 'privacy-policy-top-header-menu',
                    'url' => null,
                    'is_active' => 1,
                    'bg_image' => null,
                    'icon' => null,
        ...
        $blocks[] = [
            ...
            'child' => [
                [
                    // Logo
                    'slug' => 'privacy-policy-header-logo',
                    'url' => null,
                    'is_active' => 1,
                ...
                [
                    // Header Menu
                    'slug' => 'privacy-policy-header-menu',
                    'url' => null,
                    'is_active' => 1,
