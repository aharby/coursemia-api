                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($row->new_values as $key => $value)
                                                            <tr>
                                                                <th  class="text-center">{{ trans("countries.{$key}") }}</th>
                                                                {{--Before--}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6 text-center">
                                                            <a href="{{ route('admin.countries.get.view', request()->route('id')) }}" class="btn btn-success" target="_blank">
                                                                {{ trans('subjects.View counrties') }}
                                                            </a>
                                                        </div>
