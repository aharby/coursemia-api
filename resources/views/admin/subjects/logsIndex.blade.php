                                            ...
                                            <div class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <th class="text-center">{{ trans('app.Log Time') }}</th>
                                                            <td class="text-center"></td>
                                                            <td class="text-center">{{$row->created_at->format('H:i:s')}}</td>
                                                        </tr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-6 text-center">
                                                            <a href="{{ route('admin.subjects.get.view', request()->route('id')) }}" class="btn btn-success" target="_blank">
                                                                {{ trans('subjects.View subject') }}
                                                            </a>
                                                        </div>
