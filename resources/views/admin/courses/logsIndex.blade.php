                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($row->new_values as $key => $value)
                                                            ...
                                                            @endif
                                                            <tr>
                                                                <th  class="text-center">{{ trans("courses.{$key}") }}</th>
                                                                {{--Before--}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6 text-center">
                                                            <a href="{{ route('admin.courses.get.view', request()->route('id')) }}" class="btn btn-success" target="_blank">
