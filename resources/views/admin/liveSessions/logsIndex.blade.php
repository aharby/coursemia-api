                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        @foreach($row->new_values as $key => $value)
                                                            ...
                                                            @endif
                                                            <tr>
                                                                <th  class="text-center">{{ trans("live_sessions.{$key}") }}</th>
                                                                {{--Before--}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 col-md-6 text-center">
                                                            <a href="{{ route('admin.liveSessions.get.view', request()->route('id')) }}" class="btn btn-success" target="_blank">
                                                                {{ trans('subjects.View Live Sessions') }}
                                                            </a>
                                                        </div>
