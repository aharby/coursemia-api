                ...
                <div class="col-4">
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            {!! Form::select('quiz_type', \App\OurEdu\GeneralQuizzes\Enums\GeneralQuizTypeEnum::getAllQuizTypes() , request()->get('quiz_type'), ['id'=> "quizType", 'class' => 'form-control' , 'placeholder' => trans('quiz.type') , 'style' => 'height: 55px;']) !!}
                    ...
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            <select id="gradeClass_id" class="form-control" style="height: 55px;" name="gradeClass">
                                <option selected="selected" value="">{{ __("quiz.class") }}</option>
                ...
                <div class="col-4">
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="from_date" id="from_date" value="{{ old("from_date", request()->get("from_date")) }}" placeholder="{{ __("quiz.date") }}" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="to_date" id="to_date" value="{{ old("to_date", request()->get("to_date")) }}" placeholder="{{ __("quiz.date") }}" class="form-control">
                        </div>
                    </div>
                </div>
