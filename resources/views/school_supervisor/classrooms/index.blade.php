...
@section('buttons')
    @if(can('create-classrooms'))
        <a href="{{ route('school-branch-supervisor.classrooms.get.create', ["branch" => $branch ?? null]) }}"
                                        ...
                                        <td>
                                            @if(can('view-classrooms'))
                                                <a class="btn btn-xs btn-primary"
                                                   href="{{  route('school-branch-supervisor.classrooms.get.view', ["id" => $row->id, "branch"=>$branch?? null]) }}"
                                            ...
                                            @if(can('update-classrooms'))
                                                <a class="btn btn-xs btn-info"
                                                   href="{{  route('school-branch-supervisor.classrooms.get.edit',["id" => $row->id, "branch" => $branch]) }}"
                                                   data-toggle="tooltip" data-placement="top"
                                            ...
                                            @if(can('view-classrooms'))
                                                <a class="btn btn-xs btn-dark"
                                                   href="{{  route('school-branch-supervisor.classrooms.classroomClasses.index',["classroom" => $row->id, "branch" => $branch])}}"
                                                   data-toggle="tooltip" data-placement="top"
                                            ...
                                            @if(can('view-classrooms'))
                                                <a class="btn btn-xs btn-dark"
                                                   href="{{route('school-branch-supervisor.students.get.index',['classroom'=>$row->id, "branch" => $branch ?? null])}}"
                                                   data-toggle="tooltip" data-placement="top"
