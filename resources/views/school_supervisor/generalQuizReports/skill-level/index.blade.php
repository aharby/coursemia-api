...
@section('buttons')
    @if (!empty($generalQuizzes))
        <a href="{{ route("school-branch-supervisor.general-quizzes-reports.branch.reports.skill.levels.export", request()->query->all()) }}" class="btn btn-md btn-success align-right" target="_blank">{{ trans("app.Export") }}</a>
    @endif
@endsection
...
@section('content')
    <div class="row">
        ...
        @if (!empty($generalQuizzes))
            @include('school_supervisor.generalQuizReports.skill-level._filter')
                            ...
                            <table class="table">
                                <thead-dark>
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('quiz.View score percentage for sections') }}
                                        </th>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs"
                                                    href="{{ route('school-branch-supervisor.general-quizzes-reports.sectionPercentageReport', $quiz->id) }}"
