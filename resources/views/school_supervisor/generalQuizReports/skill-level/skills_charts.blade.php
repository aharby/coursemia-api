                ...
                datasets: [
                    {
                        ...
                        data: [
                            ...
                            "@if($sectionGrades[$key]->sum('grade') > 0 && $generalQuiz->studentsAnswered->count() >0) {{round((($section->sum('total_score')/$generalQuiz->studentsAnswered->count())/$sectionGrades[$key]->sum('grade')) * 100 ,2)}} @else 0 @endif",
