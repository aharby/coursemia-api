            ...
            <div class="row">
                            ...
                            <select id="gradeClass_id" class="form-control" style="height: 55px;" name="gradeClass">
                                ...
                                @foreach ($gradeClasses as $gradeClass)
                                    <option value="{{ $gradeClass->id }}"
                                        {{ request()->get('gradeClass') == $gradeClass->id ? 'selected' : null }}>
                                        {{ $gradeClass->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            <input type="text" autocomplete="off" name="from_date" id="from_date"
                                ...
                                placeholder="{{ __('quiz.date') }}" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 form-group">
                    <button class="btn btn-md btn-success float-right">
                        <a  style="color:#fff"  class="" href="export?{{ request()->getQueryString()}}">{{ trans('app.Export')}}</a>
