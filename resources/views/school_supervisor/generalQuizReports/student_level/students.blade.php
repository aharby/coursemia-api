...
@section('buttons')
    @if(count($students))
        <a href="{{ route("school-branch-supervisor.general-quizzes-reports.student.reports.student.levels.export", request()->query->all()) }}" target="_blank" class="btn btn-md btn-success align-right" style="margin: 10px;">{{ trans("app.Export") }}</a>
    @endif
@endsection
...
@section('content')
    <div class="row">
        @if(!empty($students))
        @include('school_supervisor.generalQuizReports.student_level._filter')
                                    ...
                                    @if($student->user)
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-info"
                                               href="{{ route('school-branch-supervisor.general-quizzes-reports.student.level.student.quizzes', ["student" => $student->user->id]). '?'.$filters }}"
