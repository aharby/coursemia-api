...
@section('buttons')
    @if (count($assessmentUsers))
        <a href="{{  route('school-branch-supervisor.result-viewers.assessments.assessees.view.exports', ['assessment' => $assessment->id, 'assessor' => $assessor->id])  }}"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs"
                                                   href="{{ route('school-branch-supervisor.result-viewers.assessments.assessees.view.details', ['assessment' => $assessment->id, 'assessor' => $assessor, 'assessee' => $assessmentUser->assessee]) }}"
