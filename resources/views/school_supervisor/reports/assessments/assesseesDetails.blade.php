...
@section('buttons')
    @if (count($assessmentUsers))
        <a href="{{  route('school-branch-supervisor.result-viewers.assessments.assessees.view.details.export', ['assessment' => $assessment->id, 'assessor' => $assessor->id, 'assessee' => $assessee->id])  }}"
