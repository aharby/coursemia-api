...
@section('buttons')
    @if (count($assessmentAssessors))
        <a href="{{ route('school-branch-supervisor.result-viewers.assessments.assessors.view.exports', ['assessment' => $assessment->id]) }}"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-xs"
                                                    href="{{ route('school-branch-supervisor.result-viewers.assessments.assessees.view', ['assessment' => $assessment->id, 'assessor' => $assessmentAssessor->user->id]) }}"
