...
@section('content')
    <div class="row">
        @include("school_admin.school_account_branches.subjects_filter")
        @if(!empty($subjects))
                                        ...
                                        <div class="modal-dialog" style="max-width: 80%; height: 70%" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route("school-admin.school-account-branches.branch.questions.branch.subjects.permissions", $subject->id) }}" method="post">
                                                        @csrf
