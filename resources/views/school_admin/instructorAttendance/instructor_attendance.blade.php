...
@section('buttons')
    @if(count($instructors))
        <a href="{{ route("school-admin.reports.instructor.sessions.attendance.export", request()->all()) }}" target="_blank" class="btn btn-md btn-success align-right">{{ trans("app.Export") }}</a>
    @endif
@endsection

@section('content')
    <div class="row">
        @include('school_admin.instructorAttendance._filter')
