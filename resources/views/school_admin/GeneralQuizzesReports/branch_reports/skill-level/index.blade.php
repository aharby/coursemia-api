...
@section('buttons')
    @if (!empty($generalQuizzes))
        <a href="{{ route("school-admin.general-quizzes-reports.branch-reports.skill.levels.export", request()->query->all()) }}" class="btn btn-md btn-success align-right" target="_blank">{{ trans("app.Export") }}</a>
    @endif
@endsection
@section('content')
    <div class="row">
                            ...
                            <table class="table">
                                ...
                                @foreach($generalQuizzes as $quiz)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="{{ route('school-admin.general-quizzes-reports.branch-reports.sectionPercentageReport', $quiz->id) }}"
