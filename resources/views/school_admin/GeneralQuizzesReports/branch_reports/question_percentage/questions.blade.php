...
@section('buttons')
    <a href="{{ route("school-admin.general-quizzes-reports.branch-reports.question.percentage.report.questions.charts", $generalQuiz->id) }}" class="btn btn-md btn-success align-right">{{ trans("general_quizzes.view chart") }}</a>
@endsection
