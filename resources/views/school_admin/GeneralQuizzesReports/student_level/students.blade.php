...
@section('buttons')
    @if(count($students))
        <a href="{{ route("school-admin.general-quizzes-reports.student.reports.student.levels.export", request()->query->all()) }}" target="_blank" class="btn btn-md btn-success align-right" style="margin: 10px;">{{ trans("app.Export") }}</a>
    @endif
@endsection
...
@section('content')
    <div class="row">
        ...
        @include('school_admin.GeneralQuizzesReports.student_level._filter')
                                    ...
                                    @if($student->user)
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-info"
                                               href="{{ route('school-admin.general-quizzes-reports.student.level.student.quizzes', ["student" => $student->user->id]). '?'.$filters }}"
