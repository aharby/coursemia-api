...
@section('buttons')
    @if(count($generalQuizzes))
        <a href="{{ route("school-admin.general-quizzes-reports.student.reports.branch.levels.export", request()->query->all()) }}" target="_blank" class="btn btn-md btn-success align-right" style="margin: 10px;">{{ trans("app.Export") }}</a>
    @endif
@endsection
...
@section('content')
    <div class="row">
        ...
        @if(!empty($generalQuizzes))
            @include('school_admin.GeneralQuizzesReports.branch-level._filter')
                            ...
                            <table class="table">
                                ...
                                @foreach($generalQuizzes as $quiz)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="{{ route('school-admin.general-quizzes-reports.branch-level-report.students', $quiz->id) }}"
