                    ...
                    <div class="card-body">
                        @switch($mediaType)
                            ...
                            <video width="100%" controls>
                                <source src="{{ getImagePath(S3Enums::LARGE_PATH . $media->filename) }}"
                            ...
                            @else
                                <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ getImagePath(S3Enums::LARGE_PATH . $media->filename) }}'
