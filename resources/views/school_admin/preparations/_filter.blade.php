                    ...
                    <div class="input-group">
                        <div class="input-group-addon">
                            <div class="input-group-text h-100">
                                {{ __("session_preparation.branches") }}
                            </div>
                        </div>

                        {!! Form::select('branch', $branches, request()->get('branch'), ['id'=> 'branch_id', 'class' => 'form-control', 'placeholder' => trans('session_preparation.branches'), 'style' => 'height: 55px;']) !!}
                    </div>
                </div>
                <div class="col-1"></div>
                <div class=" form-group">
                    <div class="input-group">
                        ...
                        {!! Form::select('classroom', $classrooms ?? [], request()->get('classroom'), ['id'=> 'classroom_id', 'class' => 'form-co   ntrol', 'placeholder' => trans('session_preparation.classroom'), 'style' => 'height: 55px;']) !!}
                    </div>
                </div>
                <div class="col-1"></div>
                <div class=" form-group">
