...
@section('content')
    <div class="row">
        @include("school_account_manager.preparations._filter")
                            ...
                            @foreach($mediaLibrary as $singleMedia)
                                <div class="col-4">
                                        <div class="subject-progress card-height">
                                            ...
                                            <div class="down">
                                                <a class="button text-center btn-block mt-3 m-0" href="{{ route('school-admin.session.preparation.get.single.media', $singleMedia) }}" class="btn btn-primary">{{ trans("session_preparation.view") }}</a>
                                            </div>
                                        </div>
                                </div>
                            @endforeach
...
@push('scripts')
    <script>
        $("#branch_id").change(function () {
            ...
            $('#classroom_id').append(`<option value="" selected> {{ trans("session_preparation.classroom") }} </option>`);
            ...
            $.get('{{ route('school-branch-supervisor.classrooms.branchClassroom.byBranch') }}' + `/${branch_id}`,
                {
