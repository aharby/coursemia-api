                        ...
                        <div class="input-group">
                            <div class="input-group-addon">
                                <div class="input-group-text h-100">
                                    {{ __('assessment.assessee_type') }}
                                </div>
                            </div>

                            {!! Form::select('assessee_type', $userTypes, request()->get('assessee_type'), ['id'=> "assessorType", 'class' => 'form-control' , 'placeholder' => trans('assessment.assessee_type') , 'style' => 'height: 55px;']) !!}
                ...
                <div class="col-4">
                    <div class=" form-group">
                        <div class="input-group">
                            ...
                            {!! Form::select('assessor_type', $userTypes, request()->get('assessor_type'), ['id'=> "assessorType", 'class' => 'form-control' , 'placeholder' => trans('assessment.assessor_type') , 'style' => 'height: 55px;']) !!}
