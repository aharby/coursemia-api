...
@section('buttons')
    @if (count($assessments))
        <a href="{{ route('school-admin.assessments.index.exports',request()->query->all()) }}"
                                ...
                                <tbody>
                                    @foreach ($assessments as $assessment)
                                        <tr class="text-center">
                                            ...
                                            <td>{{$assessment->assessed_assesses_count}}</td>
                                            <td>{{$assessment->total_assesses_count}}</td>
                                            <td>
                                                <a class="btn btn-primary btn-xs"
                                                    href="{{route('school-admin.assessments.assessors.view', ['assessment' => $assessment->id])}}"
