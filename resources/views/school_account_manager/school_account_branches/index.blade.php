                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-2 " data-step="2" data-intro="{{trans('introJs.You Can View Courses!')}}"  data-position='right' >
                                        <a class="btn btn-xs btn-primary"
                                               href="{{  route('school-account-manager.school-account-branches.get.view',$row->id) }}"
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2 " data-step="4" data-intro="{{trans('introJs.You Can Edit Courses!')}}"  data-position='right' >
                                    <div class="col-md-3 col-sm-3 col-xs-3 form-group">
                                        <a class="btn btn-xs btn-info"
                                           href="{{  route('school-account-manager.school-account-branches.get.edit',$row->id) }}"
                                           data-toggle="tooltip" data-placement="top"
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-3 form-group">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                                ...
                                                <li class="dropdown-item"><a href="{{ route('school-account-manager.reports.students.class.presence', ["branch" => $row]) }}">{{ trans('navigation.Students class Presence') }}</a></li>
                                                <li class="dropdown-item"><a href="{{ route('school-account-manager.reports.students.subjects.presence', ["branch" => $row]) }}">{{ trans('navigation.Students Subjects Presence') }}</a></li>
                                ...
                                <div class="col-md-2 col-sm-2 col-xs-2 " data-step="4" data-intro="{{trans('introJs.You Can Edit Courses!')}}"  data-position='right' >
                                    <div class="col-md-3 col-sm-3 col-xs-3 form-group">
                                        <a class="btn btn-xs btn-info"
                                           href="{{  route('school-account-manager.school-account-branches.branch.subjects.index',$row->id) }}"
                                           data-toggle="tooltip" data-placement="top"
