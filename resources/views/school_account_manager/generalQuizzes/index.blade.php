...
@section('buttons')
    @if(!empty($generalQuizzes))
        <a href="{{ route('school-account-manager.general-quizzes.index.export', array_merge(["branch" => $branch ?? null], request()->all())) }}"
...
@section('content')
    <div class="row">
        ...
        @if(!empty($generalQuizzes))
            @include('school_account_manager.generalQuizzes._filter')
                            ...
                            <table class="table">
                                ...
                                @foreach($generalQuizzes as $quiz)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="{{ route('school-account-manager.general-quizzes.students', $quiz->id) }}"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="POST" class="" action="{{route('school-account-manager.general-quizzes.delete', $quiz->id)}}">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
