...
@section('buttons')
    <a href="{{ route("school-account-manager.general-quizzes-reports.question.percentage.report.index.charts", array_merge(["branch" => $branch ?? null], request()->all())) }}" class="btn btn-md btn-success align-right">{{ trans("general_quizzes.view chart") }}</a>
@endsection
...
@section('content')
    <div class="row">
        ...
        @if(!empty($generalQuizzes))
            @include('school_account_manager.generalQuizReports.branch_reports.question_percentage._filter')
                            ...
                            <table class="table">
                                ...
                                @foreach($generalQuizzes as $quiz)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-xs" href="{{ route('school-account-manager.general-quizzes-reports.question.percentage.report.questions', $quiz->id) }}"
