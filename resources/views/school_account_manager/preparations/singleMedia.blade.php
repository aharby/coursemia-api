                ...
                <div class="card">
                    <div class="card-body">
                        @switch($mediaType)
                            ...
                            @else
                                <iframe src='https://view.officeapps.live.com/op/embed.aspx?src={{ getImagePath(S3Enums::LARGE_PATH . $media->filename) }}' style="width: 100%; min-height: 500px; height: 70vh;" frameborder='0'>
                                </iframe>
                                @break
                        @endswitch
                    </div>
