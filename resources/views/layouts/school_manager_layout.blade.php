                ...
                @else
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link" href="#">
                            ...
                            <div class="nav-profile-text">
                                @if(is_null(auth()->user()->schoolAccountBranchType))
                                    <p class="mb-1 text-black">{{auth()->user()->name}}</p>
                                @else
                                    <p class="mb-1 text-black">{{auth()->user()->name}}
                                        - {{auth()->user()->schoolAccountBranchType->name}}</p>
                                @endif
...
<div class="container-fluid page-body-wrapper">
    ...
    @else
        @include('school_account_manager.partials.navigation')
    @endif
    ...
    <input type="hidden" id="socketToken" value="{{(app(\App\OurEdu\Users\Auth\TokenManager\TokenManagerInterface::class))->createAuthToken(\App\OurEdu\Users\Auth\Enum\TokenNameEnum::DYNAMIC_lINKS_Token)}}"/>
...
<div class="video_call_modal">
    <div class="content">
        <div class="modal" tabindex="-1" role="dialog" id="video_call_request" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" onclick=handleVideoCallStatus("accepted")>{{ trans('video.accept') }}
                        </button>
                        <button type="button" class="btn btn-danger" onclick=handleVideoCallStatus("rejected")>{{ trans('video.reject') }}
                        </button>
                    </div>
                </div>
            </div>
