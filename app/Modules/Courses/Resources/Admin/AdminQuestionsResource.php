...
class AdminQuestionsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'description_en'=> $this->translate('en') ? $this->translate('en')->description : '',
            'description_ar'=> $this->translate('ar') ? $this->translate('ar')->description : '',
            'explanation_en'=> $this->translate('en') ? $this->translate('en')->explanation : '',
            'explanation_ar'=> $this->translate('ar') ? $this->translate('ar')->explanation : '',
