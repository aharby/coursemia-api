...
class WantToLearnApiController extends Controller
{
    ...
    public function addWantToLearn($questionId)
    {
        ...
        if($wantToLearn->wasRecentlyCreated)
            return customResponse(null, "Question added successfully", 200, StatusCodesEnum::DONE);
        else
            return customResponse((object)[], 'Question exists in want to lean list', 400, StatusCodesEnum::FAILED);
