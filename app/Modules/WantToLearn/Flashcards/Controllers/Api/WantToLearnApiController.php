...
class WantToLearnApiController extends Controller
{
    ...
    public function addWantToLearn(int $flashcardId)
    {
        ...
        $wantToLearn = WantToLearnFlashcard::firstOrCreate([
            ...
            return customResponse(null, "Flashcard added successfully", 400, StatusCodesEnum::FAILED);
        else
            return customResponse((object)[], 'Flashcard exists in want to lean list', 200, StatusCodesEnum::DONE);
    }
