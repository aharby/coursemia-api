...
class FillHotSpotUseCase implements FillHotSpotUseCaseInterface
{
    ...
    private function deleteQuestions(HotSpotRepository $hotSpotRepo, $questions)
    {
    ...
    private function createOrUpdateQuestions(HotSpotRepository $hotSpotRepo, $hotSpotId, $questions)
    {
        foreach ($questions as $question) {
            ...
            attachQuestionVideo($question, $questionObj, 'subject/hot_spot');
            attachQuestionAudio($question, $questionObj, 'subject/hot_spot');
        }
    }

    private function deleteAnswers(HotSpotRepository $hotSpotRepo, $answers, $questionId)
    {
    ...
    private function createOrUpdateAnswers(HotSpotRepository $hotSpotRepo, $answers, $questionId)
    {
