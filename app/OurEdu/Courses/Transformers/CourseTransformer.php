...
class CourseTransformer extends TransformerAbstract
{
    ...
    public function transform(Course $course)
    {
        ...
        return [
            ...
            'subscription_cost' => (string)$course->subscription_cost . ' ' . $currencyCode,
    ...
    public function includeActions(Course $course)
    {
        ...
        $actions[] = [
            'endpoint_url' => buildScopeRoute(
                'api.student.courses.instructorProfile',
    ...
    {
        $sessions = $course->sessions()->where('status', '!=', CourseSessionEnums::CANCELED)->get();
    ...
    public function includeHomeworks(Course $course)
    {
        if (auth()->user()->type != UserEnums::PARENT_TYPE) {
            ...
            return $this->collection($course->homeworks, new CourseHomeWorkTransformer(), ResourceTypesEnums::HOMEWORK);
        }
