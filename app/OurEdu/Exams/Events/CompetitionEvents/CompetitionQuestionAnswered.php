...
class CompetitionQuestionAnswered extends ShouldBeStored implements  StudentStoredEventContract , ShouldBroadcast
{
    ...
    public function broadcastWith()
    {
        ...
        return $data;
//        return fractal($data, new CompetitionQuestionAnsweredTransformer())
//            ->serializeWith(new JsonApiSerializer())
//            ->withResourceName(ResourceTypesEnums::COMPETITION_QUESTION_ANSWERED)
//            ->toArray();
//        return $this->transformDataModInclude($data , '' ,new CompetitionQuestionAnsweredTransformer() , ResourceTypesEnums::COMPETITION_QUESTION_ANSWERED);
    }
}
