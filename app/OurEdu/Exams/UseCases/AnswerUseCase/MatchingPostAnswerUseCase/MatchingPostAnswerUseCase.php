...
class MatchingPostAnswerUseCase implements MatchingPostAnswerUseCaseInterface
{
    ...
    public function postAnswer(ExamRepository $examRepository, ExamQuestion $examQuestion, Collection $answers)
    {
        ...
        foreach ($answers as $answer) {
            ...
            $answerData = [
                ...
                'option_table_type' => MatchingOption::class,
                'option_table_id' => $answer->answer_id,
                'single_question_type' => MatchingQuestion::class,
    ...
    {
        return $mainQuestion->options()->where('id', $answerId)->where(
