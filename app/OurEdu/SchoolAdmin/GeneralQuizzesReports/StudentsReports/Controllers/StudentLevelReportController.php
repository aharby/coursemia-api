...
class StudentLevelReportController extends BaseController
{
    /**
    ...
    {
        list($schoolStudents, $classrooms,, $gradeClasses,$branches) = $this->studentsData($request);
        $user = Auth::user();
        ...
        $data["branches"] = $request->user()->schoolAdmin->currentSchool->branches()->pluck('name' , 'id')->toArray();
        ...
        return view("school_admin.GeneralQuizzesReports.student_level.students", $data);
    }
    ...
    public function studentQuizzes(User $student,Request $request)
    {
        ...
        return view("school_admin.GeneralQuizzesReports.student_level.student_quizzess", $data);
    }
    ...
    public function studentSectionPerformance(GeneralQuizStudent $generalQuizStudent)
    {
        ...
        return view("school_admin.GeneralQuizzesReports.student_level.student_sections", $data);
    }
    ...
    private function studentsData(Request $request)
    {
        ...
        return [$schoolStudents, $classrooms, $branch, $gradeClasses,$branches];
    }
    ...
    public function studentQuizzesChart(User $student,Request $request)
    {
        $requestData = $request->all();
        if(!$request->has('branch_id')){
            $user = Auth::user();
        ...
        return view("school_admin.GeneralQuizzesReports.student_level.student_quizzes_charts", $data);
    }

    public function studentSectionPerformanceChart(GeneralQuizStudent $generalQuizStudent)
    {
        $studentSectionsGrade = 
            GeneralQuizStudentAnswer::query()
                ->where('general_quiz_id',$generalQuizStudent->general_quiz_id)
        ...
        $data["sectionsStudentsGrade"] = $sectionsStudentsGrade;
        $data["sectionGrades"] = $sectionGrades;
        return view("school_admin.GeneralQuizzesReports.student_level.student_sections_charts", $data);
    }
}
