...
namespace App\OurEdu\GeneralQuizzes\Transformers\QuestionsTransformers\TrueFalseTransformers;

use App\OurEdu\GeneralQuizzes\Models\GeneralQuizStudentAnswer;
use League\Fractal\TransformerAbstract;

class TrueFalseQuestionAnswerTransformer extends TransformerAbstract
{
    /**
     * @var array
     */
    ...
    public function transform(GeneralQuizStudentAnswer $answer)
    {
        ...
        $data = [
            'id' => (int)$answer->id,
            'answer' => (bool)$answer->answer_text
        ];
        ...
        if ($answer->optionable) {
            $optionsData = [
                ...
                'answer' => (string)$answer->optionable->option
            ];
        ...
        if (isset($answerDetails)) {
            foreach ($answerDetails as $detail) {
                $optionsData = [
                    ...
                    'answer' => (string)$detail->optionable->option
                ];
