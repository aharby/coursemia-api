...
class QuestionBankTransformer extends TransformerAbstract
{
    ...
    {
        return $this->item($questionBank->question ?? $questionBank->questions, new QuestionTransformer(
            $this->generalQuiz), ResourceTypesEnums::Periodic_Test_QUESTION_DATA
        );
    }
    ...
    public function includeActions(GeneralQuizQuestionBank $questionBank)
    {
            ...
            if(!$this->added_from_bank_questions){
                    ...
                    'label' => trans('app.Edit Periodic Test questions'),
                    'method' => 'POST',
