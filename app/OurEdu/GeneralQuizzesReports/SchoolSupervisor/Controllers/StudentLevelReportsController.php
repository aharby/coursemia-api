...
use App\OurEdu\GeneralQuizzesReports\SchoolSupervisor\Exports\StudentQuizzesExport;
use App\OurEdu\GeneralQuizzesReports\SchoolSupervisor\Exports\StudentSectionPerformanceExport;
...
class StudentLevelReportsController extends BaseController
{
    ...
    {
        list($schoolStudents, $classrooms, $branch, $gradeClasses) = $this->studentsData($request);
        ...
        $classroomsIDs = $classroomsIDs->where("branch_id", $branch->id)
            ->pluck("id")->toArray();
        ...
        return view("school_supervisor.generalQuizReports.student_level.students", $data);
    }
    ...
    public function studentQuizzes(User $student,Request $request)
    {
        ...
        $data["page_title"] = trans('general_quizzes.student_name').': '.$student->name;
        $data["user"] = $student;

        return view("school_supervisor.generalQuizReports.student_level.student_quizzess", $data);
    }
    ...
    public function studentSectionPerformance(GeneralQuizStudent $generalQuizStudent)
    {
        ...
        return view("school_supervisor.generalQuizReports.student_level.student_sections", $data);
    }
