...
class DynamicLinksEnum
{
    ...
    const GENERALEXAM_PUBLISH = '{firebase_url}/?link={portal_url}/ar/student/exams/general/{id}&apn=com.ouredu.students';
    const STUDENT_JOIN_COMPETITION = '{firebase_url}/studentJoinCompetition?link={portal_url}/student/competitions/join/share%3Fcompetition_id%3D{competition_id}%26target_screen%3D'.DynamicLinkTypeEnum::JOIN_COMPETITION.'&apn=com.ouredu.students';
    ...
    const STUDENT_JOIN_COURSE_COMPETITION = '{firebase_url}/studentJoinCompetition?link={portal_url}/student/competitions/join/share%3Fcompetition_id%3D{competition_id}%26target_screen%3D'.DynamicLinkTypeEnum::JOIN_COURSE_COMPETITION.'&apn=com.ouredu.students';
