...
namespace App\OurEdu\BaseApp\Api;


use Illuminate\Support\Facades\Http;

class AgoraHandlerV2
{
    public static function makeRequest($endPoint, $method = 'post', $paramData = [], $userToken = null)
    {
        $baseApiUrl = env('AGORA_EDU_BASE_API_V2', 'https://api.agora.io/scene/apps');
...
//        https://api.agora.io/edu/v1/apps/21aafae6820b453cab4d23799b6395f1/room/entry'
        $url = "$baseApiUrl/{$agoraAppId}/v1/{$endPoint}";
        $headers = [
        ...
        $response = Http::withHeaders($headers)->$method($url, $paramData);
