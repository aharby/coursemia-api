...
use App\OurEdu\GeneralExamReport\Models\GeneralExamReportContentAuthorTask;
use App\OurEdu\GeneralExamReport\Models\GeneralExamReportTask;
use Illuminate\Pagination\LengthAwarePaginator;

class GeneralExamReportTaskRepository implements GeneralExamReportTaskRepositoryInterface
{
    private $questionReportTask;
    use Filterable;
    public function __construct(GeneralExamReportTask $questionReportTask)
    {
     ...
     * @return task|null
     */
    public function findOrFail(int $id): ?GeneralExamReportTask
    {
    ...
    {
        return GeneralExamReportContentAuthorTask::insert($array);
    }
