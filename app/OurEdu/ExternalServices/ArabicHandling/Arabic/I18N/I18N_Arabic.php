...
namespace App\OurEdu\ExternalServices\ArabicHandling\Arabic\I18N;

use App\OurEdu\ExternalServices\ArabicHandling\Arabic\I18N\Arabic\I18N_Arabic_Glyphs;
use Exception;
...
//        }
        ...
        $this->myObject   = new I18N_Arabic_Glyphs();
    ...
    public function __call($methodName, $arguments)
    {
        ...
        $method = new \ReflectionMethod(new I18N_Arabic_Glyphs(), $methodName);
