    ...
    public function array(): array
    {
        ...
        foreach ($this->assessments as $assessment) {
            $rows[] = [
                ...
                $assessment->average_total_mark ? number_format(($assessment->average_score / $assessment->average_total_mark)*100, 2)  .'%' : 0 .'%',                (string) $assessment->assessed_assesses_count ?? "0",
                (string)$assessment->total_assesses_count ?? "0"
            ];
        }
