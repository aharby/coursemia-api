...
class ActivitiesLogTransformer extends TransformerAbstract
{
    ...
    public function transform(StudentStoredEvent $event)
    {
        $transformedData = [
            'id' => Str::uuid(),
            'text' =>  (string) trans("events.{$event->event_properties['action']}", [
                'Student' => $event->event_properties['user_attributes']['first_name']]),
        ...
        if (isset($event->event_properties['exam_attributes'])) {
            $transformedData['exam_title'] = (string) trans('app.exam_on', [
        ...
        if (isset($event->event_properties['practice_attributes'])) {
            $transformedData['exam_title'] = (string) trans('app.practice_on',[
        ...
        if (isset($event->event_properties['competition_attributes'])) {
            $transformedData['exam_title'] = (string) trans('app.competition_on',[
